...
<c:forEach var="weekvo" items="${requestScope.WeekList}" varStatus="status">

<c:forEach var ="submap" items="${requestScope.SubList}" varStatus="status">  

  <tr>
    <c:if test="${submap.lesson==1 }"><td class="tg-fzdr" rowspan="6">0${weekvo.week} ${weekvo.week}주차</td> </c:if>
    <td class="tg-fzdr" rowspan="2">${submap.lesson}차시</td>
    <td class="tg-wo29">${submap.subject} ${weekvo.week}주차-${submap.lesson}교시</td>
  ...
  <tr>
    <td class="tg-wo29">${submap.subject} ${weekvo.week}주차-${submap.lesson}교시_요약정리</td>
...
<c:forEach var="map" items="${requestScope.SubList}" varStatus="status">
<!-- The Modal -->
