...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		<%--		
			...
			frm.method = "POST";
			frm.action = "<%= ctxPath%>/noticeEditEnd.univ";
			frm.submit();
		});
	...
	<div>
		<div style="margin:auto; margin-left: padding-top:70px;">
			...
			<form name="editFrm">
				...
				<input type="hidden" name="fk_hakbun" value="${requestScope.noticevo.fk_hakbun}" readonly />
				<input type="hidden" name="name" value="${requestScope.noticevo.name}" readonly />
				<input type="hidden" name="fk_code" id="fk_code" size="100" value="${requestScope.noticevo.fk_code}" readonly />
				<div>					
					<input style="margin-bottom: 13px;" type="text" name="subject"  id="subject" size="100" value="${requestScope.noticevo.subject}" />
				</div>
				<div>					
					<textarea rows="11" cols="102" name="content" id="content">${requestScope.noticevo.content}</textarea>
				</div>
				<br>
				<br>
				<hr style="width: 843px; margin-left: 0px;">
