  ...
  <script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#MessengerToggle").click(function(){
			...
			$("div#Messenger").append("<div style='background-color: #f5a100; text-align:center; font-size:15pt;'>부천대학교 메신저</div><span id='MessangerClose' style='font-size:20pt; float:right'>&times;</span>");
