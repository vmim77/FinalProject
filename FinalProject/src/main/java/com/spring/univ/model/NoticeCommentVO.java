...
public class NoticeCommentVO {
	...
	private String status;		// 글삭제여부 ( 1사용가능한 글,  0 삭제된 글, 댓글은 원글이 삭제되면 자동적으로 삭제되어야 한다)
	
	
	
	public NoticeCommentVO() {}
	
	public NoticeCommentVO(String seq, String fk_hakbun, String name, String fk_code, String content, String regDate, String parentSeq, String status) {
		this.seq = seq;
