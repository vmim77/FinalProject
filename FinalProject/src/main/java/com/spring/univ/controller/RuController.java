...
//=========================================================================
	...
	@RequestMapping(value="/image/multiplePhotoUpload.univ", method= {RequestMethod.POST}) // attach_photos.js 참조. /board/image/multiplePhotoUpload.action 에서 /image/multiplePhotoUpload.action만 쓰면 됨
